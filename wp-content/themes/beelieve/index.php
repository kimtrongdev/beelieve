      ...
      <center style="margin-top: 40vh;">
        <svg width="198" height="149" viewBox="0 0 278 209" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="logo 5">
            <g id="hexagonM">
              <path id="Polygon 1"
                d="M116.271 29.2887L166 0.57735L215.729 29.2887V86.7113L166 115.423L116.271 86.7113V29.2887Z"
                fill="white" stroke="black" />
            </g>
            <g id="hexagonB1">
              <path id="Polygon 1_2"
                d="M8.27053 29.2887L58 0.57735L107.729 29.2887L107.729 86.7113L58 115.423L8.27053 86.7113L8.27053 29.2887Z"
                fill="black" stroke="black" />
            </g>
            <g id="hexagonB2">
              <path id="Polygon 1_3"
                d="M62.2705 122.289L112 93.5774L161.729 122.289V179.711L112 208.423L62.2705 179.711L62.2705 122.289Z"
                fill="black" stroke="black" />
            </g>
            <g id="hexagonB3">
              <path id="Polygon 1_4"
                d="M170.271 122.289L220 93.5774L269.729 122.289V179.711L220 208.423L170.271 179.711V122.289Z"
                fill="black" stroke="black" />
            </g>
          </g>
        </svg>
...
-29 0 -38 9 -23 23 12 12 41 7 47 -8z" />
        ...
        <div class="o-scroll_section">
          <section class="c-home-intro item-1" id="home">
            ...
            <div class="content">
              <p class="text-welcome">Welcome to our Hive !</p>
        ...
        <div class="o-scroll_section" id="about">
          <section class="c-block-content item-2 js-animate">

            <p class="text to-left">We Are Bees</p>

            <span>
              <p class="text-description to-right">Young, full of passion and contributing the visual beauty of the
                world into
                life. In Beelieve, we work hard and put the perfection on top as well as customer’s satisfaction. We
                help your experience in Virtual reality or Augmented reality in the most entertaining way but also
                remarkable stunning moment.</p>
            </span>
          </section>
        </div>

        <!-- Promo block -->
        <div class="o-scroll_section" id="core_values">
          <section class="c-block-details js-animate -border item-3" id="promotion_1">
            <p class="title to-left">Core values</p>
            <div class="wrap1">
              <div class="text to-right">Turning the client’s idea into effective solution and unique experience for a
                wide range
            ...
            <div class="wrap2 row">
              <div class="item to-top">
                ...
                <p class="des">Fun, Smile, and Joy</p>
              </div>
              <div class="item to-top">
                <img src="<?php bloginfo('template_directory') ?>/images/svg/page3/quality.svg" width="100%" height="100%" />
                <p class="name">Quality</p>
                <p class="des">Quality Honey is sweet and excellent so our product is also</p>
              </div>
              <div class="item to-bottom">
                <img src="<?php bloginfo('template_directory') ?>/images/svg/page3/team-work.svg" width="100%" height="100%" />
                <p class="name">Team Work</p>
                <p class="des">Team work Bees don’t work alone, they work as a team</p>
              </div>
              <div class="item to-bottom">
                <img src="<?php bloginfo('template_directory') ?>/images/svg/page3/innovation.svg" width="100%" height="100%" />
                <p class="name">Innovation</p>
                <p class="des">Innovation We believe the innovation will change the world and shape it into a better
                  place</p>
              </div>
            </div>
          </section>
        ...
        <div class="o-scroll_section" id="our_service">
          <section class="c-block-details js-animate -border item-h item-4" id="promotion_1">
            <div class="wrap">
              ...
              <div class="wrap2 to-left">
                <ul>
                  <li onmouseover="setImageService('<?php bloginfo('template_directory') ?>./images/web-development.png')">Web Development</li>
                  <li onmouseover="setImageService('<?php bloginfo('template_directory') ?>./images/App-Development.png')">App Development</li>
                  <li onmouseover="setImageService('<?php bloginfo('template_directory') ?>./images/Interactive-Game.png')">Virtual Game Event</li>
                  <li onmouseover="setImageService('<?php bloginfo('template_directory') ?>./images/AR.png')">AR / VR / 360</li>
                </ul>
                <div class="img img-service imgA ">

                </div>
          </section>
        </div>

        <div class="o-scroll_section" id="contact">
          <section class="c-block-details js-animate -border item-h item-5" id="promotion_1">
            <div class="wrap">
              <div class="next"></div>
              <div class="contact to-left">
                <h2>Contact Us</h2>
                <p><b>Address :</b>L17-11, 72 Le Thanh Ton Street, Ben Nghe Ward, District 1, HCM City</p>
                <p><b>Email : </b>hello@beelieve.vn</p>
                <p><b>Telephone : </b>028 6288 3088</p>
                <img class="" src="<?php bloginfo('template_directory') ?>/images/svg/page3/iconFB.svg" width="50" height="50" />
                <img class="" src="<?php bloginfo('template_directory') ?>/images/svg/page3/iconTele.svg" width="50" height="50" />
              </div>
              <div class="map">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.434033348689!2d106.69985311425634!3d10.778031562112563!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f47d87887ab%3A0x7f406e1f2abd3c53!2zVmluY29tIEIsIDcyIEzDqiBUaMOhbmggVMO0biwgQuG6v24gTmdow6ksIFF14bqtbiAxLCBI4buTIENow60gTWluaCwgVmnhu4d0IE5hbQ!5e0!3m2!1svi!2s!4v1593436967592!5m2!1svi!2s"
