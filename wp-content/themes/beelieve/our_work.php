...
-29 0 -38 9 -23 23 12 12 41 7 47 -8z" />
              ...
              <center class="w-100 h-75 ">
                <div class="toolbar-form h-100 w-75 border-dark p-3 d-flex align-items-center">
                  <div class="w-100">
                    ...
                    <div class="form-group text-left wrap-select row mt-3">
                      <div class="active item col">AR/VR</div>
                      <div class="item col">360</div>
                      <div class="item col">WEB</div>
                      <div class="item col">APP</div>
                    </div>
                    <button class="btn-search px-5 mt-3">Search</button>
                  </div>
                </div>
              </center>
            </div>
        ...
        <div class="o-scroll_section">
          <section class="c-block-content item-auto-width js-animate">
            ...
            <?php $GetPostsQuery = new WP_query(); $GetPostsQuery->query('post_status=publish&showposts=8&post_type=post&cat=2'); ?>
            ...
            <div class="wrap-article">
                ...
                <div class="form-group text-left wrap-select mt-3">
